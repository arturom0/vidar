class MainController < ApplicationController
  ...
  def create_computer_group
    ...
    if(server && name)
      begin
        newGroup = server.createComputerGroup(name, parentGroup, server.username)
        newGroup.save
      ...
      rescue SmsObjectCreationFailDuplicateName
        @create_computer_error_status = "Collection name is already in use. Try again."
        update_page do |page|
